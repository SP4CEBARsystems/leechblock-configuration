...
2. Use my [custom filters](https://github.com/SP4CEBARsystems/leechblock-configuration/tree/main/ublock_origin_configuration) for the [uBlock Origin](https://ublockorigin.com/) browser extention to block the remaining full-screen recommendations, these filters support both the PC and mobile versions of the YouTube website as well as YouTube players embedded into other sites.
